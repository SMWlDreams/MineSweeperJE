...
/**
 * Parses the log file for all data elements and verifies the integrity of the file
 */
public class LogParser implements ErrorHandler, ContentHandler, LexicalHandler {
    private long[] properties = new long[4];
    private List<Move> moves = new ArrayList<>();
    /**
     * The states for this specific state machine
     */
    private enum States {INIT, GAME, SEED, WIDTH, HEIGHT, MINES, SELECT, FLAG, X, Y, RESULT, END}
            ...
            case GAME:
                switch (localName.toLowerCase()) {
                    ...
                    case "select":
                        ...
                        move = new Move();
                        move.setProperty("select");
                        break;
                    case "flag":
                        states = States.FLAG;
                        tempStates = States.FLAG;
                        move = new Move();
                        move.setProperty("flag");
                        break;
                    case "result":
     ...
     * @return W for a win, L for a loss
     */
