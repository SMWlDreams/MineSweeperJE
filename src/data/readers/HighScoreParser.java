...
public class HighScoreParser extends AbstractParser {
    /**
     * The states for this specific state machine
     */
    private enum States {INIT, HIGHSCORES, PLAYER, NAME, SCORE, END}
    ...
    public void startElement(String uri, String localName, String qName, Attributes atts) throws SAXException {
        switch (states) {
            case INIT:
                if (!localName.equalsIgnoreCase("HighScores")) {
                    throw new SAXException("Expected HighScores element, found " + localName);
                }
                states = States.HIGHSCORES;
                break;
            case HIGHSCORES:
                if (!localName.equalsIgnoreCase("player"))
                        throw new SAXException("Invalid element! Found " + localName);
                states = States.PLAYER;
                break;
            case PLAYER:
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        switch (states) {
            ...
            case HIGHSCORES:
                ...
                break;
            case SCORE:
                if (!localName.equalsIgnoreCase("score")) {
                    throw new SAXException("Invalid ending element! Found " + localName);
                }
                states = States.PLAYER;
                break;
